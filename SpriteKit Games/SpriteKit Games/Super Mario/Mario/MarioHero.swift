...
class MarioHero: SKSpriteNode {
    ...
    func loadAppearance() {
        ...
        let skinColor = R.color.cream() ?? UIColor.white
        ...
        let leftEye = SKSpriteNode.init(color: eyeColor, size: CGSize(width: 6, height: 6))
        ...
        let armColor = R.color.grey() ?? UIColor.white
        ...
        hand.position = CGPoint(x: -arm.size.height * 0.9, y: hand.size.height / 2)
        arm.addChild(hand)
    ...
    func loadPhysicsBodyWithSize(size: CGSize) {
        ...
        physicsBody?.categoryBitMask = MarioPhysicsCategory.heroCategory
        physicsBody?.contactTestBitMask = MarioPhysicsCategory.enemyCategory
    ...
    func breathe() {
        ...
        let breath = SKAction.sequence([breatheOut, breathIn])
